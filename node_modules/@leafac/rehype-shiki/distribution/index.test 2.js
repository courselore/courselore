...
\`\`\`
`)
        .toString()).toMatchInlineSnapshot(`"<pre class=\\"shiki\\" style=\\"background-color: #FFFFFF\\"><code><span class=\\"line\\"><span style=\\"color: #AF00DB\\">return</span><span style=\\"color: #000000\\"> </span><span style=\\"color: #795E26\\">unified</span><span style=\\"color: #000000\\">()</span></span></code></pre>"`);
});
test("text", async () => {
    expect(unified()
        .use(remarkParse)
...
\`\`\`
`)
        .toString()).toMatchInlineSnapshot(`"<pre class=\\"shiki\\" style=\\"background-color: #FFFFFF\\"><code><span class=\\"line\\"><span style=\\"color: #000000\\">Leandro Facchinetti</span></span></code></pre>"`);
});
...
`)
            .toString();
    }).rejects.toThrowErrorMatchingInlineSnapshot(`"No language registration for not-a-language"`);
});
