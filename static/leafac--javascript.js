...
const leafac = {
  ...
  // Adapted from https://github.com/gliese1337/fast-myers-diff/tree/a2da289e88e266d55973f2897b91d19ac00c75fd
  diff(xs, ys) {
    ...
    function diff_core(i, N, j, M, eq) {
      ...
      const L = N + M;
      const b = new (
        L < 256 ? Uint8Array : L < 65536 ? Uint16Array : Uint32Array
      )(2 * Z);
      return new DiffGen({
        i,
        N,
