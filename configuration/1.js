module.exports = async (require) => {
  ...
  const localConfiguration = path.join(process.cwd(), "configuration.local.js");
  if (await fs.pathExists(localConfiguration))
    await require(localConfiguration)({ require, app });
