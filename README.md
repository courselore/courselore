...
> **Note:** CourseLore needs some network ports to be available: 80, 443, 4000, and 4001. If you have other applications bound to those network ports, you must stop them. In macOS and Linux you may find which application is bound to a network port using, for example, `lsof -i:443`.
