  ...
  application.server?.push({
    ...
    handler: async (
      ...
      if (typeof request.body.avatarImage === "object") {
        ...
        await fs.copyFile(request.body.avatarImage.path, absolutePath);
    ...
    handler: async (
      ...
      application.database.backgroundJob({
        ...
        parameters: {
          ...
          html: html`
            <p>
              Someone enabled two-factor authentication in Courselore for the
              following email address:
              <code>${request.state.user.email}</code>
            </p>
            <p>
    ...
    handler: async (
      ...
      application.database.backgroundJob({
        ...
        parameters: {
          ...
          html: html`
            <p>
              Someone disabled two-factor authentication in Courselore for the
              following email address:
              <code>${request.state.user.email}</code>
            </p>
            <p>
