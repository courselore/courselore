...
export default (app) => {
    if (app.locals.options.host !== app.locals.options.canonicalHost &&
    ...
    app.locals.handlers.about = (req, res) => {
        res.send(app.locals.layouts.base({
            req,
            res,
            head: html `
    ...
    app.get("/about", ...app.locals.middlewares.isSignedOut, app.locals.handlers.about);
    app.get("/about", ...app.locals.middlewares.isSignedIn, app.locals.handlers.about);
};
