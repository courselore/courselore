...
export const conversationTypes = ["question", "note", "chat"];
export default (app) => {
    ...
    app.locals.layouts.conversation = ({ req, res, head, sidebarOnSmallScreen = false, mainIsAScrollingPane = false, body, }) => {
        const search = typeof req.query.conversations?.search === "string" &&
        ...
        if (typeof req.query.conversations?.filters === "object" &&
            ...
            if (typeof req.query.conversations.filters.isUnread === "string" &&
            ...
            if (Array.isArray(req.query.conversations.filters.types)) {
                const types = [
                    ...new Set(req.query.conversations.filters.types.filter((type) => conversationTypes.includes(type))),
                ];
                if (types.length > 0)
                    filters.types = types;
            }
            if (filters.types?.includes("question") &&
            ...
            if (typeof req.query.conversations.filters.isPinned === "string" &&
                ["true", "false"].includes(req.query.conversations.filters.isPinned))
                filters.isPinned = req.query.conversations.filters.isPinned;
            if (typeof req.query.conversations.filters.isStaffOnly === "string" &&
            ...
            if (Array.isArray(req.query.conversations.filters.tagsReferences)) {
                const tagsReferences = [
                    ...new Set(req.query.conversations.filters.tagsReferences.filter((tagReference) => res.locals.tags.find((tag) => tagReference === tag.reference) !== undefined)),
                ];
                if (tagsReferences.length > 0)
                    filters.tagsReferences = tagsReferences;
            }
        ...
        const conversationsPage = typeof req.query.conversations?.conversationsPage === "string" &&
        ...
        const conversationsWithSearchResults = app.locals.database
          ...
          $${filters.isResolved === undefined
            ? sql ``
            : sql `
                  AND "conversations"."resolvedAt" IS $${filters.isResolved === "true" ? sql `NOT` : sql ``} NULL
                `}
          $${filters.isPinned === undefined
            ? sql ``
            : sql `
                  AND "conversations"."pinnedAt" IS $${filters.isPinned === "true" ? sql `NOT` : sql ``} NULL
                `}
          $${filters.isStaffOnly === undefined
            ? sql ``
            : sql `
                  AND "conversations"."staffOnlyAt" IS $${filters.isStaffOnly === "true" ? sql `NOT` : sql ``} NULL
                `}
          $${res.locals.enrollment.courseRole !== "staff"
            ? sql `
                  AND (
          ...
          LIMIT ${conversationsPageSize + 1} OFFSET ${(conversationsPage - 1) * conversationsPageSize}
        `)
            ...
            const searchResult = typeof conversationWithSearchResult.conversationTitleSearchResultHighlight ===
                "string"
                ? {
                    type: "conversationTitle",
                    highlight: conversationWithSearchResult.conversationTitleSearchResultHighlight,
                }
                : typeof conversationWithSearchResult.messageAuthorUserNameSearchResultMessageReference ===
                    ...
                    ? {
                        ...
                        message: app.locals.helpers.getMessage({
                            ...
                            res,
                            conversation,
                            messageReference: conversationWithSearchResult.messageAuthorUserNameSearchResultMessageReference,
                        }),
                        highlight: conversationWithSearchResult.messageAuthorUserNameSearchResultHighlight,
                    }
                    : typeof conversationWithSearchResult.messageContentSearchResultMessageReference ===
                        ...
                        ? {
                            ...
                            message: app.locals.helpers.getMessage({
                                ...
                                res,
                                conversation,
                                messageReference: conversationWithSearchResult.messageContentSearchResultMessageReference,
                            }),
                            snippet: conversationWithSearchResult.messageContentSearchResultSnippet,
                        }
                        : undefined;
            return { conversation, searchResult };
        });
        const moreConversationsExist = conversationsWithSearchResults.length === conversationsPageSize + 1;
        if (moreConversationsExist)
            ...
            >
              ...
              >
                ...
                ? html `
                    ...
                    .reference}/conversations/new/note${qs.stringify({ conversations: req.query.conversations }, { addQueryPrefix: true })}"
                          ...
                          <a
                            href="https://${app.locals.options
                    .host}/courses/${res.locals.course
                    .reference}/conversations/new/question${qs.stringify({ conversations: req.query.conversations }, { addQueryPrefix: true })}"
                          ...
                          <a
                            href="https://${app.locals.options
                    .host}/courses/${res.locals.course
                    .reference}/conversations/new/chat${qs.stringify({ conversations: req.query.conversations }, { addQueryPrefix: true })}"
                            class="button button--transparent"
                          >
                ...
                : html `
                  ...
                  >
                    ...
                    $${!util.isDeepStrictEqual(req.query.conversations?.filters, {
                isQuick: "true",
                isUnread: "true",
            })
                ? html `
                ...
                conversationsWithSearchResults.some(({ conversation }) => conversation.readingsCount <
                ...
                ? html `
                    ...
                    .host}/courses/${res.locals.course
                    .reference}/conversations/mark-all-conversations-as-read${qs.stringify({ redirect: req.originalUrl }, { addQueryPrefix: true })}"
                            >
                              <input
                                type="hidden"
                                name="_csrf"
                ...
                : html `disabled`}
                        ...
                        <div class="label">
                          ...
                          <div
                            ...
                            `)}"
                          >
                            $${conversationTypes.map((conversationType) => html `
                                <label
                                  class="button button--tight button--tight--inline button--transparent"
                                >
                                  <input
                                    ...
                                    $${req.query.conversations?.filters?.types?.includes(conversationType)
                ? html `checked`
                : html ``}
                                    $${Object.keys(filters).length > 0 &&
                filters.isQuick !== "true"
                                      ...
                                      >
                                        ...
                                        >
                                          <input
                                            ...
                                            value="${tag.reference}"
                                            $${req.query.conversations?.filters?.tagsReferences?.includes(tag.reference)
                    ? html `checked`
                    : html ``}
            ...
            >
              ...
              >
                ...
                : html `
                    ...
                    ? javascript `
                                    window.setTimeout(() => {
                                      if (event?.detail?.previousLocation?.href?.startsWith(${JSON.stringify(`https://${app.locals.options.host}/courses/${res.locals.course.reference}`)})) return;
                    ...
                    : javascript ``}
                          `}"
                        >
                          $${conversationsWithSearchResults.map(({ conversation, searchResult }) => {
                    const isSelected = conversation.id === res.locals.conversation?.id;
                    return html `
                                <a
                        ...
                        messages: {
                            messageReference: searchResult?.message?.reference,
                        },
                    }, { addQueryPrefix: true })}"
                        ...
                        searchResult,
                                  ...
                                  >
                                    $${(() => {
                        const unreadCount = conversation.messagesCount -
    ...
    app.locals.partials.conversation = ({ req, res, conversation, searchResult = undefined, message = undefined, }) => html `
    <div
      ...
      $${conversation.taggings.length === 0
        ...
        : html `
            <div
              ...
              `)}"
            >
              $${conversation.taggings.map((tagging) => html `
                  <div class="text--teal">
                    <i class="bi bi-tag-fill"></i>
                    ${tagging.tag.name}
        ...
        : searchResult?.type === "messageContent"
            ...
            <div>
              <div>
                ...
                res,
                enrollment: searchResult.message.authorEnrollment,
                anonymous: searchResult.message.anonymousAt === null
                    ? false
                    : res.locals.enrollment.courseRole === "staff" ||
            ...
            <div>
              <div>
                $${app.locals.partials.user({
                    ...
                    anonymous: message.anonymousAt === null
                        ? false
                        : res.locals.enrollment.courseRole === "staff" ||
  ...
  `;
    app.locals.helpers.getConversation = ({ req, res, conversationReference, }) => {
        const conversationRow = app.locals.database.get(sql `
      ...
      `);
        ...
        const conversation = {
            ...
            authorEnrollment: conversationRow.authorEnrollmentId !== null &&
                ...
                ? {
                    ...
                    user: {
                        ...
                        avatarlessBackgroundColor: conversationRow.authorUserAvatarlessBackgroundColor,
                        biographySource: conversationRow.authorUserBiographySource,
                        biographyPreprocessed: conversationRow.authorUserBiographyPreprocessed,
                    },
        ...
        const messagesCount = app.locals.database.get(sql `SELECT COUNT(*) AS "messagesCount" FROM "messages" WHERE "messages"."conversation" = ${conversation.id}`).messagesCount;
        const readingsCount = app.locals.database.get(sql `
      ...
      `).readingsCount;
        const endorsements = conversation.type === "question"
            ? app.locals.database
                .all(sql `
              ...
              `)
                .map((endorsement) => ({
                id: endorsement.id,
                enrollment: endorsement.enrollmentId !== null &&
                    ...
                    ? {
                        ...
                        user: {
                            ...
                            avatarlessBackgroundColor: endorsement.userAvatarlessBackgroundColor,
    ...
    app.post("/courses/:courseReference/conversations/mark-all-conversations-as-read", (req, res, next) => {
        res.locals.actionAllowedOnArchivedCourse = true;
        next();
    }, ...app.locals.middlewares.isEnrolledInCourse, (req, res) => {
        const messages = app.locals.database.all(sql `
          SELECT "messages"."id"
          FROM "messages"
        ...
        for (const message of messages)
          ...
          `);
        res.redirect(303, `https://${app.locals.options.host}${typeof req.query.redirect === "string" &&
            req.query.redirect.trim() !== ""
            ? req.query.redirect
            : "/"}`);
    });
    app.get(`/courses/:courseReference/conversations/new(/:type(${conversationTypes.join("|")}))?`, ...app.locals.middlewares.isEnrolledInCourse, ...app.locals.middlewares.liveUpdates, (req, res) => {
        const conversationDraft = typeof req.query.newConversation?.conversationDraftReference ===
            "string" &&
            req.query.newConversation.conversationDraftReference.match(/^[0-9]+$/)
            ? app.locals.database.get(sql `
                SELECT "createdAt",
                       "updatedAt",
                       "reference",
                       "type",
              ...
              `)
            : undefined;
        res.send((res.locals.conversationsCount === 0
            ...
            <title>
              ${req.params.type === "note"
                ? `Post ${res.locals.conversationsCount === 0 ? "the First" : "a New"} Note`
                : req.params.type === "question"
                    ? `Ask ${res.locals.conversationsCount === 0 ? "the First" : "a New"} Question`
                    : req.params.type === "chat"
                        ? `Start ${res.locals.conversationsCount === 0 ? "the First" : "a New"} Chat`
                        : `Start ${res.locals.conversationsCount === 0 ? "the First" : "a New"} Conversation`}
          ...
          `,
            ...
            <form
              ...
              action="https://${app.locals.options.host}/courses/${res.locals
                .course.reference}/conversations${qs.stringify({ conversations: req.query.conversations }, { addQueryPrefix: true })}"
              novalidate
              css="${res.locals.css(css `
                display: flex;
                flex-direction: column;
            ...
            >
                          ...
                          onload="${javascript `
                            this.onchange = () => {
                              ...
                              for (const element of [form.querySelector('[name="content"]'), ...form.querySelectorAll('[name="tagsReferences[]"]')])
                                element.required = ${JSON.stringify(conversationType !== "chat")};

                              ${res.locals.enrollment.courseRole === "staff"
                ? javascript `
                                      const notification = form.querySelector('[key="new-conversation--notification"]');
                                      notification.hidden = ${JSON.stringify(conversationType !== "note")};
                                      for (const element of leafac.descendants(notification))
                                        if (element.disabled !== undefined)
                                          element.disabled = ${JSON.stringify(conversationType !== "note")};
                                    `
                : javascript ``}
                            };
                          `}"
              ...
              $${app.locals.partials.contentEditor({
                req,
                res,
                contentSource: typeof conversationDraft?.content === "string" &&
                    ...
                    : conversationDraft === undefined &&
                        ...
                        : undefined,
                // TODO: Drafts
                required: (typeof req.params.type === "string" &&
                    ["question", "note"].includes(req.params.type)) ||
                    (req.params.type === undefined &&
                        ((typeof req.query.newConversation?.type === "string" &&
                            ["question", "note"].includes(req.query.newConversation.type)) ||
              ...
              $${res.locals.tags.length === 0 &&
                ...
                : html `
                    ...
                    : res.locals.tags.map((tag) => html `
                        ...
                        "string" &&
                        JSON.parse(conversationDraft.tagsReferences).includes(tag.reference)) ||
                        (conversationDraft === undefined &&
                            Array.isArray(req.query.newConversation
                                ?.tagsReferences) &&
              ...
              >
                ...
                ? html `
                    ...
                    ? html ``
                    : html `disabled`}
                              $${conversationDraft /* TODO: Conversation drafts */
                    ?.shouldNotify === "true" ||
                    (conversationDraft === undefined &&
              ...
              >
                ...
                ? html `
                    ...
                    .host}/courses/${res.locals.course
                    .reference}/conversations/new${qs.stringify({ conversations: req.query.conversations }, { addQueryPrefix: true })}"
                        onload="${javascript `
                          this.onclick = () => {
                            this.closest("form").isValid = true;
                          };
                      ...
                      <div>
                        Draft created
                        <time
                          datetime="${new Date(new Date(conversationDraft.createdAt).getTime() -
                    100 * 24 * 60 * 60 * 1000).toISOString()}"
                          onload="${javascript `
                            leafac.relativizeDateTimeElement(this, { preposition: "on", target: this.parentElement });
                          `}"
                        ></time>
                    ...
                    ? html `
                            <div>
                              Updated
                              <time
                                datetime="${new Date(conversationDraft.updatedAt).toISOString()}"
                                onload="${javascript `
                                  leafac.relativizeDateTimeElement(this, { preposition: "on", target: this.parentElement });
                                `}"
                              ></time>
    ...
    app.post("/courses/:courseReference/conversations", ...app.locals.middlewares.isEnrolledInCourse, (req, res, next) => {
        var _a;
        if (req.body.isDraft === "true") {
            // TODO: Conversation drafts: Validate inputs
            let conversationDraft = typeof req.body.conversationDraftReference === "string" &&
            ...
            if (conversationDraft === undefined)
                conversationDraft = app.locals.database.get(sql `
              ...
              VALUES (
                ...
                ${Array.isArray(req.body.tagsReferences) &&
                    req.body.tagsReferences.every((tagReference) => typeof tagReference === "string" &&
                        tagReference.trim() !== "")
            ...
            `);
              ...
              SET "updatedAt" = ${new Date().toISOString()},
                  ...
                  "isStaffOnly" = ${req.body.isStaffOnly === "on" ? "true" : null},
                  "title" = ${typeof req.body.title === "string" &&
                    req.body.title.trim() !== ""
                    ? req.body.title
                    : null},
                  "content" = ${typeof req.body.content === "string" &&
                    ...
                    ? req.body.content
                    : null},
                  "tagsReferences" = ${Array.isArray(req.body.tagsReferences) &&
                    req.body.tagsReferences.every((tagReference) => typeof tagReference === "string" &&
                        tagReference.trim() !== "")
                    ? JSON.stringify(req.body.tagsReferences)
                    : null}
            ...
            `);
            return res.redirect(303, `https://${app.locals.options.host}/courses/${res.locals.course.reference}/conversations/new${qs.stringify({
                conversations: req.query.conversations,
                newConversation: {
        ...
        (_a = req.body).tagsReferences ?? (_a.tagsReferences = []);
        if (typeof req.body.type !== "string" ||
            ...
            (res.locals.tags.length > 0 &&
                ((req.body.type !== "chat" && req.body.tagsReferences.length === 0) ||
                    ...
                    req.body.tagsReferences.some((tagReference) => typeof tagReference !== "string" ||
                        !res.locals.tags.some((existingTag) => tagReference === existingTag.reference)))) ||
        ...
        app.locals.database.run(sql `
          UPDATE "courses"
          SET "nextConversationReference" = ${res.locals.course.nextConversationReference + 1}
        ...
        for (const tagReference of req.body.tagsReferences)
            ...
            VALUES (
              ${new Date().toISOString()},
              ${conversationRow.id},
              ${res.locals.tags.find((existingTag) => existingTag.reference === tagReference).id}
            )
          `);
        if (typeof req.body.content === "string" &&
            ...
            const message = app.locals.database.get(sql `
        ...
        if (typeof req.body.conversationDraftReference === "string" &&
            req.body.conversationDraftReference.match(/^[0-9]+$/))
            app.locals.database.run(sql `
            ...
            WHERE "course" = ${res.locals.course.id} AND
                  ...
                  "authorEnrollment" = ${res.locals.enrollment.id}
          `);
        res.redirect(303, `https://${app.locals.options.host}/courses/${res.locals.course.reference}/conversations/${conversationRow.reference}${qs.stringify({
            conversations: req.query.conversations,
        }, {
            addQueryPrefix: true,
        })}`);
    ...
    app.delete("/courses/:courseReference/conversations/new", ...app.locals.middlewares.isEnrolledInCourse, (req, res, next) => {
        if (typeof req.body.conversationDraftReference !== "string" ||
            !req.body.conversationDraftReference.match(/^[0-9]+$/))
            return next("validation");
        const conversationDraft = app.locals.database.get(sql `
          SELECT "id"
          FROM "conversationDrafts"
          WHERE "course" = ${res.locals.course.id} AND
                "reference" = ${req.body.conversationDraftReference} AND
        ...
        `);
        res.redirect(303, `https://${app.locals.options.host}/courses/${res.locals.course.reference}/conversations/new${qs.stringify({ conversations: req.query.conversations }, { addQueryPrefix: true })}`);
    });
    ...
    const mayEditConversation = ({ req, res, }) => res.locals.enrollment.courseRole === "staff" ||
    ...
    app.get("/courses/:courseReference/conversations/:conversationReference", ...app.locals.middlewares.isConversationAccessible, ...app.locals.middlewares.liveUpdates, (req, res) => {
        const beforeMessage = typeof req.query.messages?.messagesPage?.beforeMessageReference ===
            "string" &&
            ...
            ? app.locals.database.get(sql `
              ...
              `)
            : undefined;
        const afterMessage = beforeMessage === undefined &&
        ...
        if (moreMessagesExist)
            messagesRows.pop();
        if (messagesReverse)
            messagesRows.reverse();
        const messages = messagesRows.map((message) => app.locals.helpers.getMessage({
            req,
            res,
        ...
        for (const message of messages)
          ...
          `);
        res.send(app.locals.layouts.conversation({
            req,
            res,
            head: html `
            <title>
            ...
            >
              ...
              >
                ...
                ? html `
                        ...
                        >
                          <span
                            ...
                            `)}"
                          >
                            $${app.locals.helpers.highlightSearchResult(html `${res.locals.conversation.title}`, typeof req.query.conversations?.search ===
                    "string" &&
                    req.query.conversations.search.trim() !== ""
                    ? req.query.conversations.search
                    : undefined)}
                ...
                ? html `
                    ...
                    ? "text--emerald"
                    : conversationTypeTextColor[res.locals.conversation.type]}"
                                  onload="${javascript `
                                    (this.tooltip ??= tippy(this)).setProps({
                                      touch: false,
                    ...
                    ? "button--blue"
                    : "button--transparent"} ${conversationTypeTextColor[conversationType]}"
                                                  >
                                                    $${conversationTypeIcon[conversationType].fill}
                                                    $${lodash.capitalize(conversationType)}
                                                  </button>
                                  ...
                                  `}"
                                >
                                  $${conversationTypeIcon[res.locals.conversation.type].fill}
                ...
                ? html `
                    ...
                    : "text--sky"}"
                                onload="${javascript `
                                  (this.tooltip ??= tippy(this)).setProps({
                                    touch: false,
                                    content: "Set as ${res.locals.conversation.staffOnlyAt ===
                    null
                    ? "Visible by Staff Only"
                    : "Visible by Everyone"}",
                                  });
                ...
                : html ``}
                    ...
                    <h2
                      ...
                      `)}"
                    >
                      $${app.locals.helpers.highlightSearchResult(html `${res.locals.conversation.title}`, typeof req.query.conversations?.search === "string" &&
                req.query.conversations.search.trim() !== ""
                ? req.query.conversations.search
                : undefined)}
                    </h2>
                ...
                for (const tagging of res.locals.conversation.taggings)
                    if (!mayEditConversation({ req, res }))
                        tags += html `
                            $${res.locals.conversation.taggings.map((tagging) => html `
                                <div class="text--teal">
                                  <i class="bi bi-tag-fill"></i>
                                  ${tagging.tag.name}
                                </div>
                ...
                if (res.locals.enrollment.courseRole === "staff" ||
                    ...
                    tags += html `
                        ...
                        : html ``}
                                        ...
                                        <div class="dropdown--menu">
                                          $${res.locals.tags.map((tag) => !res.locals.conversation.taggings.some((tagging) => tagging.tag.id === tag.id)
                        ? html `
                                                  <form
                                                    key="tag--${tag.reference}"
                                                    method="POST"
              ...
              $${(() => {
                const firstUnreadMessage = messages.find((message) => message.reading === null);
                return html `
                  <div
                    css="${res.locals.css(css `
                      ${res.locals.conversation.type === "chat"
                    ...
                    : html `
                        ...
                        ? html `
                            ...
                            messages: {
                                ...req.query.messages,
                                messagesPage: {
                                    beforeMessageReference: messages[0].reference,
                                },
                            },
                        }, {
                            addQueryPrefix: true,
                        ...
                        : html ``}
                              $${messages.map((message) => html `
                                    <div
                                      ...
                                      data-content-source="${JSON.stringify(message.contentSource)}"
                                      class="message"
                                      css="${res.locals.css(css `
                                        ${res.locals.conversation.type ===
                        "chat"
                        ...
                        const actions = html `
                                ...
                                res,
                                                                    ...
                                                                    (this.tooltip ??= tippy(this)).setProps({
                                                                      ...
                                                                      onShow: async () => {
                                                                        ...
                                                                        leafac.loadPartial(content, await (await fetch("https://${app
                                .locals
                                .options
                                .host}/courses/${res.locals
                                .course
                                .reference}/conversations/${res.locals
                                .conversation
                                .reference}/messages/${message.reference}/views")).text());
                            ...
                            .reference)} + "/" + ${JSON.stringify(message.reference)} + "\\n>\\n> " + content.replaceAll("\\n", "\\n> ") + "\\n\\n",
                                                          ...
                                                          <button
                                                            ...
                                                            onload="${javascript `
                                                              ...
                                                              this.onclick = async () => {
                                                                await navigator.clipboard.writeText("https://${app.locals
                            .options
                            .host}/courses/${res.locals.course
                            .reference}/conversations/${res.locals
                            .conversation
                            ...
                            : html ``}
                                          ...
                                          `;
                        let header = html ``;
                        if (app.locals.helpers.mayEditMessage({
                            req,
                            res,
                            message,
                        }) &&
                            ...
                            header += html `
                                            ...
                                            `;
                        if (app.locals.helpers.mayEndorseMessage({
                            req,
                            res,
                            message,
                        })) {
                            const isEndorsed = message.endorsements.some((endorsement) => endorsement.enrollment !==
                                "no-longer-enrolled" &&
                            ...
                            header += html `
                                ...
                                ? html `
                                                      <button
                                                        ...
                                                        onload="${javascript `
                                                          (this.tooltip ??= tippy(this)).setProps({
                                                            touch: false,
                                                            content: ${JSON.stringify(`Remove Endorsement${message.endorsements.filter((endorsement) => endorsement.enrollment !==
                                    "no-longer-enrolled" &&
                                    endorsement
                                        .enrollment
                                        .id !==
                                        res.locals
                                            ...
                                            .id).length > 0
                                    ? ` (Also endorsed by ${
                                    /* FIXME: https://github.com/microsoft/TypeScript/issues/29129 */ new Intl.ListFormat("en").format(message.endorsements.flatMap((endorsement) => endorsement.enrollment !==
                                        "no-longer-enrolled" &&
                                        endorsement
                                            .enrollment
                                            .id !==
                                ...
                                : html `
                                                      <button
                                                        ...
                                                        $${message.endorsements.filter((endorsement) => endorsement.enrollment !==
                                    "no-longer-enrolled").length === 0
                                    ? html ``
                                    : html `
                                                              onload="${javascript `
                                                                (this.tooltip ??= tippy(this)).setProps({
                                                                  touch: false,
                                                                  content: ${JSON.stringify(`Endorse (Already endorsed by ${
                                    /* FIXME: https://github.com/microsoft/TypeScript/issues/29129 */ new Intl.ListFormat("en").format(message.endorsements.flatMap((endorsement) => endorsement.enrollment ===
                                        "no-longer-enrolled"
                                        ? []
                                        : [
                        ...
                        else if (res.locals.conversation.type ===
                            "question" &&
                            (message.authorEnrollment ===
                                "no-longer-enrolled" ||
                                message.authorEnrollment
                            ...
                            header += html `
                                ...
                                ? javascript `
                                                          (this.tooltip ??= tippy(this)).setProps({
                                                            content: ${JSON.stringify(`Endorsed by ${
                                /* FIXME: https://github.com/microsoft/TypeScript/issues/29129 */ new Intl.ListFormat("en").format(message.endorsements.flatMap((endorsement) => endorsement.enrollment ===
                                    "no-longer-enrolled"
                                    ? []
                                    : [
                        ...
                        return html `
                            ...
                            anonymous: message.anonymousAt ===
                                ...
                                : res.locals.enrollment
                                    ...
                                    ? "reveal"
                                    : true,
                            name: message.authorEnrollment ===
                                "no-longer-enrolled"
                                ? undefined
                                : app.locals.helpers.highlightSearchResult(html `${message
                                    .authorEnrollment
                                    .user.name}`, typeof req.query
                                    .conversations
                                    ?.search ===
                                    "string" &&
                                    req.query.conversations.search.trim() !==
                        ...
                        res,
                        type: "preprocessed",
                        content: message.contentPreprocessed,
                        decorate: true,
                        search: typeof req.query.conversations
                            ?.search === "string" &&
                            req.query.conversations.search.trim() !==
                                ""
                            ? req.query.conversations
                        ...
                        const isLiked = message.likes.some((like) => like.enrollment !==
                            "no-longer-enrolled" &&
                            like.enrollment.id ===
                                res.locals.enrollment.id);
                        const likesCount = message.likes.length;
                        if (res.locals.conversation.type !==
                            "chat" ||
                            likesCount > 0)
                            messageShowFooter += html `
                                ...
                                : html `
                                                          onload="${javascript `
                                                            (this.tooltip ??= tippy(this)).setProps({
                                                              touch: false,
                                                              content: ${JSON.stringify(isLiked
                                    ? "Remove Like"
                                    : "Like")},
                                                            });
                                                          `}"
                            ...
                            messageShowFooter += html `
                                ...
                                res,
                                                    ...
                                                    (this.tooltip ??= tippy(this)).setProps({
                                                      ...
                                                      onShow: async () => {
                                                        this.tooltip.setContent(loading);
                                                        leafac.loadPartial(content, await (await fetch("https://${app.locals.options
                                .host}/courses/${res.locals.course.reference}/conversations/${res.locals.conversation
                                .reference}/messages/${message.reference}/views")).text());
                                                        this.tooltip.setContent(content);
                                                      },
                                                    });
                        ...
                        ? html `
                            ...
                            compact: res.locals.conversation
                                .type === "chat",
                        })}
                        ...
                        ? html `
                            ...
                            messages: {
                                ...req.query.messages,
                                messagesPage: {
                                    afterMessageReference: messages[messages.length - 1]
                                        .reference,
                                },
                            },
                        }, {
    ...
    const mayEditConversationMiddleware = [
        ...app.locals.middlewares.isConversationAccessible,
        (req, res, next) => {
            if (mayEditConversation({ req, res }))
                return next();
    ...
    app.patch("/courses/:courseReference/conversations/:conversationReference", ...mayEditConversationMiddleware, (req, res, next) => {
        if (typeof req.body.type === "string")
        ...
        if (typeof req.body.isResolved === "string")
            if (res.locals.conversation.type !== "question" ||
                ...
                app.locals.database.run(sql `
              UPDATE "conversations"
              SET "resolvedAt" = ${req.body.isResolved === "true" ? new Date().toISOString() : null}
              WHERE "id" = ${res.locals.conversation.id}
            `);
        if (typeof req.body.isPinned === "string")
            if (!["true", "false"].includes(req.body.isPinned) ||
                res.locals.enrollment.courseRole !== "staff" ||
                ...
                app.locals.database.run(sql `
              UPDATE "conversations"
              SET "pinnedAt" = ${req.body.isPinned === "true" ? new Date().toISOString() : null}
              WHERE "id" = ${res.locals.conversation.id}
            `);
        if (typeof req.body.isStaffOnly === "string")
            if (!["true", "false"].includes(req.body.isStaffOnly) ||
                res.locals.enrollment.courseRole !== "staff" ||
                ...
                app.locals.database.run(sql `
              UPDATE "conversations"
              SET "staffOnlyAt" = ${req.body.isStaffOnly === "true"
                    ? new Date().toISOString()
                    : null}
              WHERE "id" = ${res.locals.conversation.id}
            `);
        if (typeof req.body.title === "string")
            if (req.body.title.trim() === "")
              ...
              WHERE "id" = ${res.locals.conversation.id}
            `);
        res.redirect(303, `https://${app.locals.options.host}/courses/${res.locals.course.reference}/conversations/${res.locals.conversation.reference}${qs.stringify({
            conversations: req.query.conversations,
            messages: req.query.messages,
        }, {
            addQueryPrefix: true,
    ...
    app.delete("/courses/:courseReference/conversations/:conversationReference", ...app.locals.middlewares.isCourseStaff, ...app.locals.middlewares.isConversationAccessible, (req, res) => {
        app.locals.database.run(sql `DELETE FROM "conversations" WHERE "id" = ${res.locals.conversation.id}`);
        ...
        res.redirect(303, `https://${app.locals.options.host}/courses/${res.locals.course.reference}${qs.stringify({
            conversations: req.query.conversations,
            messages: req.query.messages,
        }, {
            addQueryPrefix: true,
    ...
    app.post("/courses/:courseReference/conversations/:conversationReference/taggings", ...mayEditConversationMiddleware, (req, res, next) => {
        if (typeof req.body.reference !== "string" ||
            !res.locals.tags.some((tag) => req.body.reference === tag.reference) ||
            res.locals.conversation.taggings.some((tagging) => req.body.reference === tagging.tag.reference))
            return next("validation");
        app.locals.database.run(sql `
          INSERT INTO "taggings" ("createdAt", "conversation", "tag")
          VALUES (
            ${new Date().toISOString()},
            ${res.locals.conversation.id},
            ${res.locals.tags.find((tag) => req.body.reference === tag.reference).id}
          )
        `);
        res.redirect(303, `https://${app.locals.options.host}/courses/${res.locals.course.reference}/conversations/${res.locals.conversation.reference}${qs.stringify({
            conversations: req.query.conversations,
    ...
    app.delete("/courses/:courseReference/conversations/:conversationReference/taggings", ...mayEditConversationMiddleware, (req, res, next) => {
        if ((res.locals.conversation.taggings.length === 1 &&
            res.locals.conversation.type !== "chat") ||
        ...
        app.locals.database.run(sql `
          ...
          WHERE "conversation" = ${res.locals.conversation.id} AND
                "tag" = ${res.locals.tags.find((tag) => req.body.reference === tag.reference).id}
        `);
        res.redirect(303, `https://${app.locals.options.host}/courses/${res.locals.course.reference}/conversations/${res.locals.conversation.reference}${qs.stringify({
            conversations: req.query.conversations,
            messages: req.query.messages,
