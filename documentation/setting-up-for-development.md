...
> **Note:** Courselore needs some network ports to be available: 80, 443, 4000, and 4001. Stop other applications you may have running on those ports. In macOS and Linux, for example, you may find what application is running on a network port by using `lsof -i:80`.
